...
- **目前所在**：Week 1 完成（Day 6 Mock #1 debrief + Rate Limiter 導入；Day 7 彈性複習：容量估算刻意練習、Week 1 building blocks cheat sheet、弱點→Mock #2 檢查清單；`daily_road_map/2026-09-01-day6.md`、`daily_road_map/2026-09-02-day7.md`）。準備進入 Week 2 Day 1（Rate Limiter 演算法比較 + Distributed rate limiting）
...
- **每日問答記錄**：`daily_road_map/2026-08-19-day2.md`、`daily_road_map/2026-08-20-day3.md`、`daily_road_map/2026-08-21-day4.md`、`daily_road_map/2026-09-01-day6.md`、`daily_road_map/2026-09-02-day7.md`
