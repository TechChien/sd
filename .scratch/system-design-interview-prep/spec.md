...
- **目前所在**：Week 1 Day 6 完成（Mock #1 debrief + Rate Limiter 概念導入：四種演算法、token/leaky bucket、distributed rate limiting 挑戰；`daily_road_map/2026-09-01-day6.md`），準備進入 Day 7（彈性複習）→ Week 2 Day 1（Rate Limiter 深入）
...
- **每日問答記錄**：`daily_road_map/2026-08-19-day2.md`、`daily_road_map/2026-08-20-day3.md`、`daily_road_map/2026-08-21-day4.md`、`daily_road_map/2026-09-01-day6.md`
